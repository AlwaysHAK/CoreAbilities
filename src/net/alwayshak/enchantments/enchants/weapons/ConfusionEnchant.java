...
public class ConfusionEnchant extends CustomEnchant {

    public static ConfusionEnchant ENCHANT;

    public ConfusionEnchant(String name, String displayName, String description, int maxLevel) {
