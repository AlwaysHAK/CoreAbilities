...
public class EnderSlayerEnchant extends CustomEnchant {

    public static EnderSlayerEnchant ENCHANT;

    public EnderSlayerEnchant(String name, String displayName, String description, int maxLevel) {
        super(name, displayName, description, maxLevel);
        ENCHANT = this;
    }

    public boolean conflictsWith(Enchantment enchantment) {
        if (enchantment.getKey().getNamespace() == AquaAspectEnchant.ENCHANT.getKey().getNamespace()) return true;
        return false;
    }
