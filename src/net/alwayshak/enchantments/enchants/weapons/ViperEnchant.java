...
public class ViperEnchant extends CustomEnchant {

    public static ViperEnchant ENCHANT;

    public ViperEnchant(String name, String displayName, String description, int maxLevel) {
    ...
    public boolean conflictsWith(Enchantment enchantment) {
        ...
        if(enchantment.getKey().getNamespace() == BlindEnchant.ENCHANT.getKey().getNamespace()) return true;
        return false;
    }
        ...
        if(hand.getEnchantments().containsKey(this)) {
            ...
            if(level == 1) {
                if(Utils.randomChance(20)) {
                    entity.addPotionEffect(new PotionEffect(PotionEffectType.POISON, 40, 0));
                }
            }
            if(level == 2) {
